...
namespace rwa2 {
    ...
    class Mouse {
         ...
         */
        bool traverse_stack();
        bool vector_contains(std::vector<Node> v, const Node& n);
        bool vector_contains_next_direction(std::vector<Node> v, int x, int y);
        void mlog(const std::string& text);
        void nlog(const int& num);
        void print_stack();
        std::stack<Node> s;
        std::stack<Node> r_s;
        std::vector<Node> v;
        ...
        Node g;
        int direction;
        bool is_same(Node& n, Node& g);
        bool move_mouse(Node x, Node y);
        void empty_stack(std::stack<Node> xyz);
        std::stack<Node> reverse_stack(std::stack<Node> abc);
